...
jalan("\033[1;92m             | |  (_)   | |")             
jalan("\033[1;92m  _ __   __ _| | ___ ___| |_ __ _ _ __  Nasa Gang ✔ ") 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://https://www.facebook.com/AnikSRz420.power/c/AsimPardasi')
    else:
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed By DMC    I 💓 A--•◈•---»" #Dev:DMC
